...
public class Config {
    ...
    public static ForgeConfigSpec.ConfigValue<Integer> BASE_EXPERIENCE_DRAIN_RATE;
    ...
    private static void setupFirstBlockConfig() {
        ...
        BASE_EXPERIENCE_DRAIN_RATE = COMMON_BUILDER.comment("If EXPDrain is enabled. How much experience should be drained each repair")
